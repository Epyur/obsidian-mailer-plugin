...
src/
  ...
  views/emails.view.ts      — Все UI: ItemView + 7 модальных окон
...
- **7 модальных окон**: CreateEmail (с изображениями), EditEmail (с изображениями), DirectionsManager, ChatLLM, ImportJSON, ResizableModal (базовый)
